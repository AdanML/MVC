...
// Implementación en modo texto de la vista

public class TextualConversor implements InterfazVista {
	...
	public void escribeCambio(String s) { // Invocado por el controlador
	...
	public double getCantidad() { // Invocado por el controlador
